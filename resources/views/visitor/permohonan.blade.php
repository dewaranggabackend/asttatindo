            ...
            <div class="col-md-8 col-sm-8">
              <div class="post-content">	
                ...
                <div class="post-description">	
                  <h1>
                    <b><center> Alur Proses Permohonan </center>
                    </b>
                  </h1>						
                  <hr>
                  <div class="post-img">
                    ...
                    <hr>
                    <img src="/permohonan/permohonansertifikatbaru.png">
                    <div>
                        ...
                        <hr>
                    <img src="/permohonan/sertifikatperpanjangan.png">
                    </div>
                    <div><br>
                    <hr>
                    <p class="permohonan">Permohonan Sertifikat Kenaikan Jenjang atau Kualifikasi</p>
                    <hr>
                    <img src="/permohonan/kenaikanjenjang.png">
                    </div>
                  </div>
                </div>				
              </div>
