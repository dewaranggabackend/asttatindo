                        ...
                        <ul class="paddingaa">
                            <b>
                                ...
                                <li class="margind">
                                    ...
                                    <ul>
                                        <li class="marginb">
                                            <a class="paddinga margina" href="#">CEK STATUS PROSES SERTIFIKASI UNTUK ASESI </a>
                                        </li>
                                        <li class="marginb">
                                        ...
                                        <li class="marginb">
                                            <a class="paddinga margina" href="/tahapan-pelaksanaan-sertifikasi">PROSEDUR </a>
                                        </li>
                                        <li class="marginb">
...
<footer class="footer">
    ...
    <ul class="footer__nav">
        ...
        <li class="nav__item">
            ...
            <ul class="nav__ul">
                <li>
                    <a href="https://goo.gl/maps/S93BrCe5JyFdFY4bA">Jl. Saharjo No. 76C Pasar Manggis, Setiabudi Jakarta
                        Selatan
                    </a>
                </li>
                <li>
